      ...
      <div className="ptf-main">
        <div className="ptf-page ptf-page--team">
          <section>
              ...
              <div className="row align-items-center">
                <div className="col-12 col-md-9">
                  ...
                  >
                    ...
                    <p className="margin-130">
                      COMMUNITY-ORIENTED MATHEMATICS PROJECTS FOR AMBITIOUS STEM
                      STUDENTS
                    </p>
                  </div>
                </div>
            ...
            {/* <!--Spacer--> */}
            <p className="margin-90">
              We're a team of UCSD students passionate about integrating{" "}
              <b>math</b>, <b>technology</b>, <b>and human-centered design</b>{" "}
