        ...
        <div className="ptf-main">
          <div className="ptf-page ptf-page--home-default">
            ...
            <section className="has-accent-1-background">
              {/* <!--Spacer--> */}
              <div className="ptf-spacer" style={{ "--ptf-xxl": "7rem" }}></div>
                ...
                >
                  ...
                  >
                    ...
                    <p className="margin-left-500  space-300">
                      ...
                      <br />
                      <br />
                      Conducting research inquiries with the aim of fostering
                      positive societal impact on a global scale
                      <br />
                      <br />
                      Create impactful career experiences for student members{" "}
                    </p>
                ...
                >
                  ...
                  >
                    <div
                      ...
                      data-aos-delay="0"
                    >
                      <h2 className="h1 space-300 d-inline-flex">
                        Our Projects
                      </h2>
                      {/* <!--Spacer--> */}
                      <div
            ...
            <div className="row align-items-center">
              <div className="col-12 col-md-9">
                ...
                <div
                  ...
                  data-aos-delay="0"
                >
                  <p className="margin-504">Announcements & Events</p>
                  <h2 className="h1 d-inline-flex margin-260">Announcements</h2>
                </div>
              </div>
        ...
        <section className="has-accent-1-background">
          ...
          <div className="container-xxl">
            ...
            <div
              ...
              data-aos-delay="0"
            >
              <h2 className="h1  space-180 d-inline-flex">
            ...
            <div className="row">
              <div className="col-xl-10">
                ...
                <div
                  ...
                  data-aos-delay="0"
                >
                  <h2 className="h1 large-heading space-400 d-inline-flex">
                    Join our voyage
                  </h2>
                  {/* <!--Spacer--> */}
                  <div
